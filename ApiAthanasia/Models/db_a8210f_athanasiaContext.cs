...
{
    public partial class db_a8210f_athanasiaContext : DbContext
    {
        public db_a8210f_athanasiaContext()
        {
        }

        public db_a8210f_athanasiaContext(DbContextOptions<db_a8210f_athanasiaContext> options)
            : base(options)
        {
        }
